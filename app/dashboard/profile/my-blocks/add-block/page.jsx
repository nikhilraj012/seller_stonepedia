    ...
    : [];
          ...
          if (block.thumbnail) {
            const thumbnailRef = ref(
              storage,
              `blocks/${uid}/thumbnails/${Date.now()}_${
                block.thumbnail.name
              }`
            );
      ...
      // Save to Firestore
 const docRef=await addDoc(collection(db, "BuyAndSellBlocks"), blocksData);
      ...
      // );
      await setDoc(
  doc(db, "Users", uid, "SellBlocks", docRef.id),
  blocksData
);
