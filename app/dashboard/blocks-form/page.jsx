...
//   return (
//     <div className='pt-14'>
//         <h1 className='text-2xl font-bold text-[#141219]'>Blocks Form</h1>
//     </div>
//   )
// }
...
const page = () => {
  ...
  const { navigate, setShowUserLogin, isSubmitting, setIsSubmitting } = useUi();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //   blocksData
      // );
      await setDoc(doc(db, "SellerDetails", uid, "SellBlocks", docRef.id), blocksData);
      ...
      resetBlockFields();
      setBlocksList([]);
      // navigate("/stonepedia-for-business/buy-and-sell-blocks");
    } catch (error) {
              ...
              <div>
                ...
                {isEditMode ? null : (
                  <div className="flex justify-end gap-2 mt-5 text-xs md:text-sm">
                    ...
                    <button
                      type="submit"
                      className={`cursor-pointer px-4 py-1 bg-[#871B58] rounded-lg text-white ${
                        isSubmitting ? "cursor-not-allowed opacity-50" : ""
                      }`}
                      disabled={isSubmitting}
                    >
