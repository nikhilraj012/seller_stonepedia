            ...
            <div className="border p-3 rounded-lg border-gray-300 bg-white">
              <div className="text-[10px] md:text-xs text-[#636363] space-y-1.5">
                <div className="flex items-start">
                  ...
                  <span className="w-[60%] leading-4 ">
                    {displayArray(p.finish)}
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="font-semibold text-black w-[40%]">
                ...
                <div className="flex items-start">
                  ...
                  <span className="w-[60%] leading-4 flex gap-1 ">
                    <span>{p.units}</span>
                  </span>
                </div>
                <div className="flex items-start">
                  ...
                  <span className="w-[60%] leading-4 break-words">
                    H -
