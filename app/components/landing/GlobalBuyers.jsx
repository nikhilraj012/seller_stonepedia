...
const GlobalBuyers = () => {
  return (
    <div className="bg-[#1e1e1e] px-6 pt-6 md:px-10 md:pt-10">
      <div className="max-w-[1728px] mx-auto flex flex-col gap-16 overflow-hidden">
        {/* Top Section */}
        <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between gap-8">
          ...
          <div className="flex flex-col gap-4 border-2 border-[#8e8e8e] rounded-[20px] md:rounded-3xl p-4 md:p-5 w-full md:w-sm">
            <p className="text-[#b4b4b4] text-2xl md:text-3xl lg:text-5xl font-medium">
              24x7
            </p>
        ...
        <div className="-mb-2">
          <div className="flex flex-col justify-center w-full">
            <div className="text-[#393939]">
              <span className="text-7xl md:text-8xl font-semibold font-outfit">
                190+
              </span>
              <span className="text-xl md:text-2xl lg:text-[70px] font-medium font-outfit">
